    ...
    public function handleExportConfereeCsv($msExcel = false)
    {
        ...
        foreach ($allConferee as $conferee) {
            ...
            @fputcsv($df, [
                ...
                $extended['city'] ?? null,
                $extended['psc'] ?? null,
                $extended['country'] ?? null,
                $extended['isStudent'] ?? null,
                $extended['ssVs'] ?? null,
                $extended['schoolName'] ?? null,
                $extended['schoolLevel'] ?? null,
                $extended['schoolField'] ?? null,
                $extended['schoolCity'] ?? null,
                $extended['reasons'] ?? null,
                $extended['experience'] ?? null,
                $extended['profi'] ?? null,
                $extended['year'] ?? null,
                $extended['sex'] ?? null,
            ], $delimiter, '"');
